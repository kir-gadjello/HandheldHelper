...
class CodeBlockBuilder extends MarkdownElementBuilder {
  ...
  final List<Widget> Function(String? s)? buttonsBuilder;
  final bool suppressCopyBtn;
    ...
    if (element.children.isNotEmpty) {
      ...
      child = Stack(
        children: [
          ...
          if (!suppressCopyBtn || buttonsBuilder != null)
            Positioned(
              right: 0,
              top: 0,
              child: (buttonsBuilder == null)
                  ? CopyButton(
                      textWidget,

...
void main() {
  ...
  test('SYNC parseGGUF correctly parses a GGUF file', () {
    final filePath =
        Platform.environment["TESTGGUF"] ?? "test/hermes2.5.header.gguf";

    final short_metadata_parsed = parseGGUFsync(filePath, findKeys: {
      "general.architecture",
      "general.name",
      "llama.context_length"
    });
    ...
    final full_metadata_parsed = parseGGUFsync(filePath);
